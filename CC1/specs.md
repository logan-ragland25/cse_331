...
Your solution will be evaluated using 7 test cases. Each test case is worth points as follows:

- **test_basic_case**: 14 points
- **test_empty_array**: 14 points
- **test_one_coin**: 14 points
- **test_no_gaps**: 14 points
- **test_large_numbers**: 14 points
- **test_unsorted_array**: 14 points
- **test_all_same_coins**: 16 points

**Total: 100 points**

Each test case must pass completely to receive points for that test case.
